...
namespace Music_Shop.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        {
            return await _context.Users.Include(u => u.Orders).Where(u => u.Id.Equals(id)).SingleOrDefaultAsync();
        }
        ...
        {
            return await _context.Users.Include(u => u.Orders).Where(u => u.UserName == name).SingleOrDefaultAsync();
        }
    }
}
