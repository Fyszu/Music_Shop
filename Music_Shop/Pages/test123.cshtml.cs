...
namespace Music_Shop.Pages
{
    public class test123Model : PageModel
    {
        ...
        public test123Model(UserManager<User> userManager, SignInManager<User> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostRegisterAsync(string? returnUrl = null)
        {
            ...
            {
                var user = new User { UserName = InputRegister.EmailRegister, Email = InputRegister.EmailRegister };
